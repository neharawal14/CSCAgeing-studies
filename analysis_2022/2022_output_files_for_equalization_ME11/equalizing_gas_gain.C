#define equalizing_gas_gain_cxx
#include "equalizing_gas_gain.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
void equalizing_gas_gain :: Loop(){
...
std::vector<float> equalizing_gas_gain :: trimmed_mean(TH2D *myh){
...
/*
float equalizing_gas_gain :: trimmed_mean_special(TH1D *myh,int chambernb,int endcap,int layer){
